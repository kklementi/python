...
#Kasuta Python Turtles’i, et joonistada stseen, kus redel toetub majale 53° nurga all.
    ...
    #Redeli kaugus seinast: kasuta tangensfunktsiooni (tan) ja antud nurka, et leida, kui kaugele
    #redeli alumine ots on seinast. Valem:
    #Kaugus=Ko˜rgus seinaltan⁡(Nurk) 
    #Redeli pikkus: kasuta Pythagorase teoreemi, et leida redeli pikkus, kui tead redeli kõrgust
    #seinal ja kaugust seinast. Valem:
...
c = math.hypot(korgus,kaugus) #sama mis eelmine rida
